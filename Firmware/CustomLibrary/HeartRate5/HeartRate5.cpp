...
void HeartRate5::configureSamplingRate() {
    // Set PRPCT to 31,999 for a period of 32,000 ticks
    writeRegister(0x1D, 31999); // Set PRPCT register value

    // Set CLKDIV_PRF for a clock division ratio of 16
    uint8_t clkDivPrf = 1;
    writeRegister(0x39, clkDivPrf); // Set CLKDIV_PRF register
